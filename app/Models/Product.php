...
class Product extends Model
{
     ...
     * 
     * @param bool $isGuest Whether this is for guest view (uses guest routes)
     */
    ...
    /**
     * Get guest additional photos URLs (uses guest routes).
     * 
     * @return array
     */
    public function getGuestAdditionalPhotosUrls(): array
    {
        if (empty($this->additional_photos)) {
            return [];
        }
        ...
        return array_map(function ($photo) {
            ...
            return route('guest-product.picture', $photo);
        }, $this->additional_photos);
    }
     ...
     * NOTE: This uses the product ID for route binding, not slug!
     * The slug is stored for SEO/URL purposes but routes bind to ID.
     */
    ...
    /**
     * Get the guest product picture URL.
     */
    public function getGuestProductPictureUrl()
    {
        if ($this->product_picture === 'default-product-picture.png') {
            return asset('images/default-product-picture.png');
        }
        
        return route('guest-product.picture', $this->product_picture);
    }
