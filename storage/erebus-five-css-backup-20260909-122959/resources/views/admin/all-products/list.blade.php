...
<link rel="stylesheet" href="{{ asset('css/erebus/views/admin/all-products/list.css') }}">
@section('content')
                        ...
                        <tr>
                            ...
                            <td class="all-products-index-actions">
                                ...
                                @if($product->isFeatured())
                                    <form action="{{ route('admin.products.unfeature', $product) }}" method="POST inline-434fc32ec2">
                                        @csrf
                                ...
                                @else
                                    <form action="{{ route('admin.products.feature', $product) }}" method="POST inline-434fc32ec2">
                                        @csrf
                                ...
                                <form action="{{ route('admin.products.destroy', $product) }}" method="POST inline-434fc32ec2">
                                    @csrf
                                    @method('DELETE')
