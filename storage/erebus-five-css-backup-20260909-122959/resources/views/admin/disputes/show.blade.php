...
<link rel="stylesheet" href="{{ asset('css/erebus/views/admin/disputes/show.css') }}">
@section('content')
...
<div class="disputes-show-container">
    ...
    <div class="disputes-show-card">
        ...
        @if($dispute->status === \App\Models\Dispute::STATUS_ACTIVE)
            <form action="{{ route('disputes.add-message', $dispute->id) }}" method="POST inline-0ca29beddf">
                @csrf
                <div class="disputes-show-form-group">
