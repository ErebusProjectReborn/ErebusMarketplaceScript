...
<link rel="stylesheet" href="{{ asset('css/erebus/views/orders/show.css') }}">
@section('content')
        ...
        <div class="orders-show-payment-container">
            ...
            @if(!$order->is_paid)
                <div class="orders-show-payment-card">
                    ...
                    <h2 class="orders-show-payment-subtitle inline-5fa693f3d4">Payment Address</h2>
        ...
        <div class="orders-show-reviews-container">
            <div class="orders-show-reviews-card">
                ...
                <div class="orders-show-reviews-list">
                    ...
                    @empty
                        <div class="orders-show-review-item inline-76067bc39e">
