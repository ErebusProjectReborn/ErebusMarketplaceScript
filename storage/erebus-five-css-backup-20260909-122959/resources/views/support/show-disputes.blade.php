...
<link rel="stylesheet" href="{{ asset('css/erebus/views/support/show-disputes.css') }}">
@section('content')
    ...
    <div class="disputes-show-container">
        <div class="disputes-show-header">
            ...
            <a href="{{ route('support.index') }}" class="disputes-show-back-link">Return to Support</a>
        </div>
        ...
        <div class="disputes-show-card">
            ...
            @if($dispute->status === \App\Models\Dispute::STATUS_ACTIVE)
                <form action="{{ route('support.disputes.add-message', $dispute->id) }}" method="POST">
                    @csrf
                    <div class="disputes-show-form-group">
                        ...
                        <textarea 
                            ...
                            placeholder="Type your message here...{{ $errors->has('message') ? ' - ' . $errors->first('message') : '' }}" 
                            required 
                            minlength="4" 
