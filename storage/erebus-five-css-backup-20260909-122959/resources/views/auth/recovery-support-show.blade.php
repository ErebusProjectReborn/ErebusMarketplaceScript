...
<link rel="stylesheet" href="{{ asset('css/erebus/views/auth/recovery-support-show.css') }}">
...
<div class="recovery-page">
    ...
    <section class="recovery-section">
        ...
        <div class="recovery-section inline-a13a1e7463">
            <h4 class="inline-611adc13da">For Substance Use Crisis</h4>
            <p class="inline-8d165127d1"><strong>1-800-662-4357</strong></p>
            <p class="inline-1af193826a">SAMHSA National Helpline - Free, confidential, 24/7<br/>Treatment referral and support</p>
        </div>
