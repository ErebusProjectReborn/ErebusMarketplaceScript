## Connecting Monero Wallet RPC to Erebus Marketplace Script

This guide will walk you through connecting a Monero wallet RPC to your Erebus Marketplace Script installation.
...
```bash
cd monero-x86_64-linux-gnu-v0.18.4.3
```
...
When prompted:
1. Enter "erebus-wallet" as your wallet name
2. Type "Y" to confirm
...
--wallet-file /root/Downloads/monero-x86_64-linux-gnu-v0.18.4.3/erebus-wallet \
--prompt-for-password \
--trusted-daemon \
...
Your Monero wallet RPC should now be properly configured and ready to use with your Erebus Marketplace Script installation.
